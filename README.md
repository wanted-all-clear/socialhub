...
> 6. [Github Issue & Jira 를 통한 Task 트래킹 관리 (WBS) 🏃‍♀️‍➡️](#github-issue--jira-를-통한-task-트래킹-관리-wbs-%EF%B8%8F%EF%B8%8F)
> 7. [Discord을 활용한 소통 및 PR 알림 봇 🤖](#discord을-활용한-소통-및-pr-알림-봇-)
> 8. [프로젝트 환경](#프로젝트-환경)
> 9. [기술 선택 이유](#기술-선택-이유)
