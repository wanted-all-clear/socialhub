...
public class PostServiceImpl implements PostService {
	...
	public PostResponse updatePost(String username, Long postId, PostUpdateRequest updateRequest) {
		...
		if (!post.getUser().getUsername().equals(username))
			throw new CustomException(POST_OWNER_MISMATCH);
	 ...
	 */
	@Override
	public PostPaging searchPosts(Pageable pageable, String username, String hashtag, PostType type, String query,
			String orderBy, String sort, String searchBy) {

		return new PostPaging(
				postRepository.searchPosts(pageable, username, hashtag, type, query, orderBy, sort, searchBy));
	}
